const artistas = [
  ...
  /* CantidadArtistaPorInstrumento: que tome por parámetro un array de artista y devuelve un objeto donde cada "instrumento" 
  es una propiedad y su valor la cantidad de artista que tocan dicho instrumento. */
  const cantidadArtistaPorInstrumento = (array) => {

    let cantidadInstrumento = {};

    array.forEach((artista) => {
        if (cantidadInstrumento[artista.instrumento]) {
            cantidadInstrumento[artista.instrumento] += 1;
        } else {
            cantidadInstrumento[artista.instrumento] = 1;
        }
    });
...
console.log(cantidadArtistaPorInstrumento(artistas));